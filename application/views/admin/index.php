             ...
             <div class="col p-0">
               <div class="card border-left-dark shadow h-100 py-2">
                 <div class="card-body">
                   <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                       <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">DBMS</div>
                       <div class="h5 mb-0 font-weight-bold text-gray-800">Hafsa Noorain - 1DA20CS045</div>
                     </div>
                     <div class="col-auto">
